package com.sc.utils.payment.data;
...
public class WCPayReqData {
    ...
    private int total_fee = 0;//订单总金额，只能为整数（单位分）
     ...
     */
    public WCPayReqData(String appid,String mchid,String key,String trade_type,String body,String detail,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,String notify_url,String openid,String product_id){
        ...
        //随机字符串，不长于32 位
        setNonce_str(RandomStringUtils.randomAlphanumeric(32));
